...
c.style = "position:fixed;left:0px;top:0px;user-select:none;pointer-events:none;z-index:-1;height:125%;padding:0;margin:0;display: block;cursor: crosshair;"
c.id = "rain"
...
var rainDrops = [];
var elements = document.getElementsByClassName("raindrop");
var length = 20;
var speed = 12;
...
var spawnInterval = setInterval(newDrop, 60);
