...
define("scripts/collide.js", function(exports) {
	...
	function lineXEllipse(p1, p2, c, r, e) {
		...
		if (!((sign(result[0][0] - p1[0]) * sign(result[0][0] - p2[0]) <= 0) && (sign(result[0][1] - p1[1]) * sign(result[0][1] - p2[1]) <= 0))) result[0] = null;
		if (!((sign(result[1][0] - p1[0]) * sign(result[1][0] - p2[0]) <= 0) && (sign(result[1][1] - p1[1]) * sign(result[1][1] - p2[1]) <= 0))) result[1] = null;
		return result
	}
...
define("scripts/game.js", function(exports) {
	...
	exports.start = function() {
		snd = sound.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/sound/throw");
		boomSnd = sound.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/sound/boom");
...
define("scripts/main.js", function(exports) {
	...
	var tip = "";
	if (!Ucren.isChrome) tip = "$为了获得最佳流畅度，推荐您使用 <span class='b'>Google Chrome</span> 体验本游戏";
	if (!buzz.isSupported()) tip = tip.replace("$", "您的浏览器不支持 &lt;audio&gt 播放声效，且");
	tip = tip.replace("$", "");
...
define("scripts/sence.js", function(exports) {
	...
	var gameStartSnd;
	exports.init = function() {
		menuSnd = sound.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/sound/menu");
		gameStartSnd = sound.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/sound/start");
		...
		return cache[key] = {
			...
			set: function() {
				...
				return function(value) {
					var c;
					stack[key] = value;
					if (lastValue !== value && (c = callbacks[key])) for (var i = 0, l = c.length; i < l; i++) c[i].call(this, value);
					lastValue = value
				}
			}(),
			get: function() {
...
define("scripts/factory/fruit.js", function(exports) {
	...
	var dropTime = 1200,
		...
		shadowPos = 50;
	var infos = {
		boom: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/boom.png", 66, 68, 26, 0, 0, null],
		peach: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/peach.png", 62, 59, 37, -50, 0, "#e6c731"],
		sandia: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/sandia.png", 98, 85, 38, -100, 0, "#c00"],
		apple: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/apple.png", 66, 66, 31, -54, 0, "#c8e925"],
		banana: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/banana.png", 126, 50, 43, 90, 0, null],
		basaha: ["https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/fruit/basaha.png", 68, 72, 32, -135, 0, "#c00"]
	};
	...
	ClassFruit.prototype.set = function(hide) {
		var inf = infos[this.type],
			radius = this.radius;
		this.shadow = layer.createImage("fruit", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/shadow.png", this.startX - radius, this.startY - radius + shadowPos, 106, 77);
	...
	ClassFruit.prototype.checkForFallOutOfViewer = function(y) {
		if (y > 480 + this.radius) this.checkForFallOutOfViewer = Ucren.nul, this.rotateAnim && this.rotateAnim.stop(), message.postMessage(this, "fruit.fallOutOfViewer")
	};
	exports.create = function(type, originX, originY, isHide, flameStart) {
		if (typeof type == "number") isHide = originY, originY = originX, originX = type, type = getType();
...
define("scripts/lib/ucren.js", function(exports) {
	...
	Array.prototype.filter = function(fn, context) {
		var result = [],
			val;
		for (var i = 0, len = this.length; i < len; i++) if (val = this[i], fn.call(context, val, i, this)) result.push(val);
		return result
	};
	...
	Ucren.BasicDrag = Ucren.Class(function(conf) {
	...
	Ucren.BasicElement = Ucren.Class(function(el) {
		this.dom = el;
		this.countMapping = {}
	}, {
		isUcrenElement: true,
		...
		useMouseAction: function(className, actions) {
			if (!this.MouseAction) this.MouseAction = new Ucren.MouseAction({
				element: this
			});
...
define("scripts/object/background.js", function(exports) {
	...
	exports.set = function() {
		image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/background.jpg", 0, 0, 640, 480)
	};
...
define("scripts/object/developing.js", function(exports) {
	...
	exports.anims = [];
	exports.set = function() {
		this.image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/developing.png", 103, 218, 429, 53).hide().scale(1e-5, 1e-5)
	};
...
define("scripts/object/dojo.js", function(exports) {
	...
	var tween = require("scripts/lib/tween");
	exports = rotate.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/dojo.png", 41, 240, 175, 175, 1e-5, tween.exponential.co, 500);
	return exports
});
define("scripts/object/flame.js", function(exports) {
	...
	exports.create = function(ox, oy, start) {
		...
		var nx = ox,
			ny = oy;
		var image = layer.image("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/smoke.png", nx - 21, ny - 21, 43, 43).hide();
		var flames = {};
...
define("scripts/object/flash.js", function(exports) {
	...
	var dur = 100;
	exports.set = function() {
		image = layer.createImage("flash", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/flash.png", 0, 0, 358, 20).hide();
		snd = sound.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/sound/splatter")
	};
...
define("scripts/object/game-over.js", function(exports) {
	...
	exports.anims = [];
	exports.set = function() {
		this.image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/game-over.png", 75, 198, 490, 85).hide().scale(1e-5, 1e-5)
	};
	exports.show = function(start) {
		timeline.createTask({
			start: start,
...
define("scripts/object/home-desc.js", function(exports) {
	...
	var tween = require("scripts/lib/tween");
	exports = displacement.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/home-desc.png", 161, 91, -161, 140, 7, 127, tween.exponential.co, 500);
	return exports
});
define("scripts/object/home-mask.js", function(exports) {
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/home-mask.png", 640, 183, 0, -183, 0, 0, tween.exponential.co, 1e3);
	return exports
});
define("scripts/object/knife.js", function(exports) {
	...
	exports.through = function(x, y) {
		...
		var ret = null;
		if (lastX !== null && (lastX != x || lastY != y)) new ClassKnifePart({
			sx: lastX,
			sy: lastY,
			ex: x,
			ey: y
...
define("scripts/object/logo.js", function(exports) {
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/logo.png", 288, 135, 17, -182, 17, 1, tween.exponential.co, 1e3);
	return exports
});
define("scripts/object/lose.js", function(exports) {
	...
	var conf1 = {
		src: "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/x.png",
		sx: 650,
		ex: 561,
		y: 5,
		w: 22,
	...
	var conf2 = {
		src: "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/xx.png",
		sx: 671,
		ex: 582,
		y: 5,
		w: 27,
	...
	var conf3 = {
		src: "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/xxx.png",
		sx: 697,
		ex: 608,
		y: 6,
		w: 31,
	...
	exports.scaleImage = function(image) {
		var dur = 500;
		image.myOnScaling = image.myOnScaling ||
		function(time, z) {
			this.scale(z = back(time, 1e-5, 1 - 1e-5, dur), z)
		};
		image.myOnScaleEnd = image.myOnScaleEnd ||
		function() {
			this.scale(1, 1)
		};
		timeline.createTask({
	...
	function createPosShow(x) {
		var image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/lose.png", x - 27, 406, 54, 50).scale(1e-5, 1e-5);
		var duration = 500;
		var control = {
			show: function(start) {
				timeline.createTask({
...
define("scripts/object/new-game.js", function(exports) {
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	exports = rotate.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/new-game.png", 244, 231, 195, 195, 1e-5, tween.exponential.co, 500);
	return exports
});
define("scripts/object/new.js", function(exports) {
	...
	exports.anims = [];
	exports.set = function() {
		image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/new.png", sx, sy, sw, sh)
	};
...
define("scripts/object/ninja.js", function(exports) {
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/ninja.png", 244, 81, 315, -140, 315, 43, {
...
define("scripts/object/quit.js", function(exports) {
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	exports = rotate.create("https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/quit.png", 493, 311, 141, 141, 1e-5, tween.exponential.co, 500);
	return exports
});
define("scripts/object/score.js", function(exports) {
	...
	exports.anims = [];
	exports.set = function() {
		image = layer.createImage("default", "https://cdn.jsdelivr.net/gh/ctz45562/cdn@1.8.1/fruit-ninja/images/score.png", imageSx, 8, 29, 31).hide();
